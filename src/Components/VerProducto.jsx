        ...
        <div className="info">
         ...
         { verProducto.marca && 
          ...
          }
          {
            ...
            verProducto.tallesLetras.length >= 1 ? (                    
              crearOptionTalles(verProducto.tallesLetras, verProducto.id)
            )
            : (
            crearOptionTalles({ desde: verProducto.tallesNumericosDesde, hasta: verProducto.tallesNumericosHasta }, verProducto )
            )
            :
            ''
          }
